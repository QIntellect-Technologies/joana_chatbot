...
/* Tooltip on mic: single button, auto language with number conversion */
if (mic) {
  mic.setAttribute(
    "title",
    "🎤 Click and speak in English or Arabic.\nNumber words are automatically converted to digits.\nExample: 'two burgers' → '2 burgers' | 'أربعة قهوة' → '4 قهوة'"
  );
}
