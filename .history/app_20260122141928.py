...
def correct_arabic_typos_with_ai(msg: str) -> str:
    ...
    system_prompt = (
        "أنت خبير في تصحيح الأخطاء الإملائية العربية والتعرف على أسماء الأطعمة.\n\n"
        "مهمتك: تصحيح النص العربي ومطابقته مع قائمة الطعام.\n\n"
        "قائمة الطعام (العربية - الإنجليزية):\n"
        f"{menu_context}\n\n"
        "قواعد التصحيح:\n"
        "1. إصلاح الأخطاء الإملائية الشائعة (تورتيلا → تورتيا، شكشوكه → شكشوكة)\n"
        "2. مطابقة الكلمات العامية بأسماء القائمة الصحيحة:\n"
        "   - 'فشار' → 'بوفك دجاج' (Chicken Popcorn)\n"
        "   - 'برغر' → 'برجر'\n"
        "   - 'بطاطا' → 'بطاطس'\n"
        "3. الحفاظ على الأرقام كما هي (٦، ٨، ١)\n"
        "4. إذا وجدت كلمة قريبة من قائمة الطعام، استخدم الاسم الصحيح من القائمة\n"
        "5. الحفاظ على بنية الجملة (الكميات، حروف العطف)\n\n"
        "أمثلة:\n"
        "المدخل: '٦ فشار، ٨ بطاطس مقليه'\n"
        "المخرج: '٦ بوفك دجاج، ٨ بطاطس مقلية'\n\n"
        "المدخل: '١ تورتيلا دجاج جامبو'\n"
        "المخرج: '١ تورتيا دجاج جامبو'\n\n"
        "المدخل: '٤ ساندوتش شكشوكه'\n"
        "المخرج: '٤ ساندويتش شكشوكة'\n\n"
        "المدخل: 'كبابب دجاج جامبووو'\n"
        "المخرج: 'كباب دجاج جامبو'\n\n"
        "أرجع النص المصحح فقط، بدون شرح أو تعليق."
    )
