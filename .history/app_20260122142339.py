...
def whatsapp_webhook():
    ...
    def looks_like_order_or_menu(text: str) -> bool:
        ...
        # ✅ Enhanced detection: Menu keywords, OR Arabic order intent, OR (numbers AND food keywords)
        return has_menu_keyword or has_arabic_intent or (has_numbers and has_food_keyword)
