...
def parse_intelligent_order(msg: str, lang: str = "en") -> dict:
    ...
    try:
        ...
        system_prompt = (
            ...
            "CRITICAL RULES:\n"
            "1. **WRAPS = SANDWICHES**: When user says 'wrap', 'wraps', 'tortilla' OR Arabic 'ساندويتش' → category=\"sandwich\"\n"
            "   Examples:\n"
            "   - '3 wraps' → {\"type\": \"generic\", \"category\": \"sandwich\", \"qty\": 3}\n"
            "   - '5 ساندويتش' → {\"type\": \"generic\", \"category\": \"sandwich\", \"qty\": 5}\n"
            "2. **SIDES/SNACKS**: 'sides', 'snacks', 'side' OR Arabic 'مقبلات', 'جانبي' → category=\"snacks_sides\"\n"
            "   Example: '5 sides' or '5 مقبلات' → {\"type\": \"generic\", \"category\": \"snacks_sides\", \"qty\": 5}\n"
