...
def chat():
    ...
    # ✅ CRITICAL FIX: For Arabic at add_more stage, try intelligent parsing BEFORE conversational fallback
    ...
    if lang == "ar" and s.get("stage") == "add_more" and not is_cancel_text(msg):
