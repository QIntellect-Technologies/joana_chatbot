...
def get_llm_reply(msg, lang="en"):
    ...
    sys_prompt = (
        ...
        "- For IRRELEVANT or UNSUPPORTED questions (non-food, non-restaurant), respond:\n"
        "  'Sorry, I cannot assist with that. Let me show you our menu.'\n"
        "- For food-related questions, help the user order.\n"
        "- Can answer restaurant questions (hours, location, menu).\n"
