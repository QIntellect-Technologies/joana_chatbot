...
def handle_multi_item_text(msg_raw, s, MENU, lang):
    ...
    # ✅ ADD ALL GENERICS TO QUEUE (priority: food items first, then burgers/sandwiches)
    food_only = [
    ...
    # ✅ CRITICAL FIX: Add BOTH to queue in priority order (food first, then burgers/sandwiches)
    all_generics_ordered = food_only + bs_only
...
def parse_intelligent_order(msg: str, lang: str = "en") -> dict:
    ...
    try:
        ...
        system_prompt = (
            ...
            "CRITICAL RULES:\n"
            "1. **WRAPS = SANDWICHES**: When user says 'wrap', 'wraps', or 'tortilla', treat it as 'sandwich' category.\n"
            "   Examples:\n"
            "   - '3 wraps' → {\"type\": \"generic\", \"category\": \"sandwich\", \"qty\": 3}\n"
            "   - '5 tortillas' → {\"type\": \"generic\", \"category\": \"sandwich\", \"qty\": 5}\n"
            "2. **SIDES/SNACKS**: When user says 'sides', 'snacks', 'side', treat as category=\"snacks_sides\"\n"
            "   Example: '5 sides' → {\"type\": \"generic\", \"category\": \"snacks_sides\", \"qty\": 5}\n"
            "3. If user says generic category (\"burger\", \"sandwich\", \"wrap\", \"drink\", \"meal\", \"juice\", \"side\", \"snack\") → type=\"generic\"\n"
            "4. If user mentions SPECIFIC item name (partial or full) matches menu => type=\"specific\"\n"
            "   (e.g. \"chicken\" -> \"Chicken Burger\", \"beef\" -> \"Beef Burger\", \"pepsi\" -> \"Pepsi\")\n"
            "5. MATCHING RULE: If input is \"2 chicken\" and menu has \"Chicken Burger\", return SPECIFIC item \"Chicken Burger\", NOT generic.\n"
            "6. Handle typos intelligently: cofee→Coffee, burgur→Burger, sandwihc→Sandwich, wrps→wraps\n"
            "7. Extract quantities: \"2 chicken and 3 beef\" → {\"type\":\"specific\", \"name\":\"Chicken Burger\", \"qty\":2}, {\"type\":\"specific\", \"name\":\"Beef Burger\", \"qty\":3}\n"
            "8. Extract ALL items from multi-item orders: \"5 burgers and 5 sides\" → [{\"type\":\"generic\", \"category\":\"burger\", \"qty\":5}, {\"type\":\"generic\", \"category\":\"snacks_sides\", \"qty\":5}]\n"
            "9. Detect preferences: spicy/non-spicy for burgers\n\n"
            "OUTPUT (JSON ONLY):\n"
            "{\n"
            "  \"items\": [\n"
            ...
            "- For wraps/tortillas, ALWAYS use category=\"sandwich\"\n"
