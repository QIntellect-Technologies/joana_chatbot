...
def whatsapp_webhook():
    ...
    # BUT skip welcome if it looks like an order!
    if not from_button and (is_first_interaction or is_wa_greeting(user_text)):
        # If it looks like an order, DON'T show welcome - let it be processed as order
        if is_first_interaction and looks_like_order(user_text):
