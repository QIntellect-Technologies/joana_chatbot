...
def handle_multi_item_text(msg_raw, s, MENU, lang):
    ...
    # ✅ STEP 1: AI-POWERED ARABIC TYPO CORRECTION (if Arabic detected)
    # This fixes common mistakes BEFORE parsing: فشار→بوفك دجاج, تورتيلا→تورتيا, etc.
    corrected_msg = correct_arabic_typos_with_ai(msg_raw)
    
    # ✅ STEP 2: USE INTELLIGENT PARSER (with corrected input)
