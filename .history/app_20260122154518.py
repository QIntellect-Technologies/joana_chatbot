...
def transcribe_audio_from_cloud(media_id: str) -> str:
    ...
    """
    if not media_id:
        print("⚠️ No media_id provided")
        return ""
    if not WHATSAPP_TOKEN:
        print("⚠️ WHATSAPP_TOKEN not configured")
        return ""
    ...
    try:
        ...
        # Detect format from WhatsApp metadata or default to .ogg
        ...
        # Auto-detects language (English or Arabic) and handles dialects
        ...
        with open(temp_audio_path, "rb") as audio_file:
            transcript = client.audio.transcriptions.create(
                ...
                language=None,  # Auto-detect (supports 50+ languages including Arabic)
