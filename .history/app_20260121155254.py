...
def parse_intelligent_order(msg: str, lang: str = "en") -> dict:
    ...
    try:
        ...
        system_prompt = (
            ...
            "RULES:\n"
            "1. CRITICAL: \"wraps\" = \"sandwiches\" (same category). If user says \"wrap\"/\"wraps\"/\"tortilla\" → category=\"sandwich\"\n"
            ...
            "5. Handle typos intelligently: cofee→Coffee, burgur→Burger, sandwihc→Sandwich\n"
            "6. Extract quantities: \"2 chicken and 3 beef\" → {\"type\":\"specific\", \"name\":\"Chicken Burger\", \"qty\":2}, {\"type\":\"specific\", \"name\":\"Beef Burger\", \"qty\":3}\n"
            "7. Detect preferences: spicy/non-spicy for burgers\n\n"
            "OUTPUT (JSON ONLY):\n"
            "{\n"
            "  \"items\": [\n"
