...
def parse_intelligent_order(msg: str, lang: str = "en") -> dict:
    ...
    try:
        ...
        system_prompt = (
            ...
            "2. If user says generic category (\"burger\", \"sandwich\", \"wrap\", \"drink\", \"meal\", \"juice\") → type=\"generic\"\n"
            "3. If user mentions SPECIFIC item name (partial or full) matches menu => type=\"specific\"\n"
            "   (e.g. \"chicken\" -> \"Chicken Burger\", \"beef\" -> \"Beef Burger\", \"pepsi\" -> \"Pepsi\")\n"
            "4. MATCHING RULE: If input is \"2 chicken\" and menu has \"Chicken Burger\", return SPECIFIC item \"Chicken Burger\", NOT generic.\n"
            "5. Handle typos intelligently: cofee→Coffee, burgur→Burger, sandwihc→Sandwich, wrps→wraps\n"
            "6. Extract quantities: \"2 chicken and 3 beef\" → {\"type\":\"specific\", \"name\":\"Chicken Burger\", \"qty\":2}, {\"type\":\"specific\", \"name\":\"Beef Burger\", \"qty\":3}\n"
            "7. Extract ALL items from multi-item orders: \"4 burgers and 3 wraps and 4 coffee\" → 3 separate items\n"
            "8. Detect preferences: spicy/non-spicy for burgers\n\n"
            "OUTPUT (JSON ONLY):\n"
            "{\n"
            "  \"items\": [\n"
