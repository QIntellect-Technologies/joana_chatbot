...
def whatsapp_webhook():
    ...
    # ✅ SMART GREETING - Show welcome for ANY first message OR greeting keywords
    ...
    # Show welcome if: (1) first interaction with ANY text, OR (2) greeting keywords anytime
