...
def detect_generic_requests_ordered(msg: str):
    ...
    def add(kind, pos):
        ...
        if kind == "sandwich":
            ...
            # Simple check: If specific sandwich exists, we typically skip generic.
            # But "wrap" is almost always generic in this context unless "Chicken Wrap" exists in specific map.
            if not msg_has_specific_sandwich(raw):
